...
1) Default Constructor :
      ...
      our class not having any constructor by programmer. It is used to initialized instance variables with default value.
...
Q.1) What is Constructor Chaining ?
    ans : Withing a class when one constructor calls other constructor using this() keyword,
...
Q.2) What us this and super ?
     ...
     => Parent class constructor can not call multiple time using same object.
        no effect will occour when we use super() when super class no arg constructor is already executed.
 */
